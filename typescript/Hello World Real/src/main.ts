...
import Human from "./models/Human.mjs";
import Rumah from "./models/Rumah.js";

function createLog(msg: string): HTMLDivElement {
...
function consoleSayName(customer: Human) {
...
const tes = (tesw: boolean): boolean => tesw ? true : false
